...
defuse a expression, then eval this expression within data-masking.

当表达式中包含函数的参数时，需要使用额外的手段保证能正确defuse。例如{{}}

defuse expression 的类型：
...
quosure 是特殊的defused expression，可以使R追踪对象的来源（命名空间）
